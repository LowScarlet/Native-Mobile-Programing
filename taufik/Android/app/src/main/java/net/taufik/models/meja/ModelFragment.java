package net.taufik.models.meja;
...
public class ModelFragment extends Fragment {
    ...
    public void showCreateModal() {
        ...
        // TODO EDIT
        EditText nomor = Utils.createEditText(context, "nomor");
        inputContainer.addView(nomor);
        EditText kapasitas = Utils.createEditText(context, "kapasitas");
        inputContainer.addView(kapasitas);
    ...
    public void showUpdateModal(Integer id, Model model) {
        ...
        // TODO EDIT
        EditText nomor = Utils.createEditText(context, "nomor");
        nomor.setText(String.valueOf(model.nomor));
        inputContainer.addView(nomor);

        EditText kapasitas = Utils.createEditText(context, "kapasitas");
        kapasitas.setText(String.valueOf(model.kapasitas));
        inputContainer.addView(kapasitas);
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.nomor, Integer.parseInt(nomor.getText().toString()))) {
                updatedModel.put("nomor", Integer.parseInt(nomor.getText().toString()));
            }

            if (!Objects.equals(model.kapasitas, Integer.parseInt(kapasitas.getText().toString()))) {
                updatedModel.put("kapasitas", Integer.parseInt(kapasitas.getText().toString()));
            }
