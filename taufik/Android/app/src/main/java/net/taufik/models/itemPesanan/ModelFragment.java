...
public class ModelFragment extends Fragment {
    ...
    public void showCreateModal() {
        ...
        EditText kuantitas = Utils.createEditText(context, "kuantitas");
        inputContainer.addView(kuantitas);
        EditText pesananId = Utils.createEditText(context, "pesananId");
        inputContainer.addView(pesananId);
        EditText menuId = Utils.createEditText(context, "menuId");
        inputContainer.addView(menuId);
        ...
        dialogView.findViewById(R.id.createButton).setOnClickListener(v -> {
            Model createdModel = new Model(
                    ...
                    Utils.tryParseInt(kuantitas.getText().toString(), 0),
                    Utils.tryParseInt(pesananId.getText().toString(), 0),
                    Utils.tryParseInt(menuId.getText().toString(), 0)
            );
    ...
    public void showUpdateModal(Integer id, Model model) {
        ...
        EditText kuantitas = Utils.createEditText(context, "kuantitas");
        kuantitas.setText(String.valueOf(model.kuantitas));
        inputContainer.addView(kuantitas);

        EditText pesananId = Utils.createEditText(context, "pesananId");
        pesananId.setText(String.valueOf(model.pesananId));
        inputContainer.addView(pesananId);

        EditText menuId = Utils.createEditText(context, "menuId");
        menuId.setText(String.valueOf(model.menuId));
        inputContainer.addView(menuId);
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.kuantitas, Integer.parseInt(kuantitas.getText().toString()))) {
                updatedModel.put("kuantitas", Integer.parseInt(kuantitas.getText().toString()));
            }
            if (!Objects.equals(model.pesananId, Integer.parseInt(pesananId.getText().toString()))) {
                updatedModel.put("pesananId", Integer.parseInt(pesananId.getText().toString()));
            }
            if (!Objects.equals(model.menuId, Integer.parseInt(menuId.getText().toString()))) {
                updatedModel.put("menuId", Integer.parseInt(menuId.getText().toString()));
            }
