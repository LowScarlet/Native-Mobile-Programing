...
public class ModelFragment extends Fragment {
    ...
    public void showCreateModal() {
        ...
        EditText jumlahTotal = Utils.createEditText(context, "jumlahTotal");
        inputContainer.addView(jumlahTotal);
        ...
        dialogView.findViewById(R.id.createButton).setOnClickListener(v -> {
            Model createdModel = new Model(
                    ...
                    Utils.tryParseInt(jumlahTotal.getText().toString(), 0),
    ...
    public void showUpdateModal(Integer id, Model model) {
        ...
        EditText jumlahTotal = Utils.createEditText(context, "jumlahTotal");
        jumlahTotal.setText(String.valueOf(model.jumlahTotal));
        inputContainer.addView(jumlahTotal);
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.jumlahTotal, Integer.parseInt(jumlahTotal.getText().toString()))) {
                updatedModel.put("jumlahTotal", Integer.parseInt(jumlahTotal.getText().toString()));
            }
