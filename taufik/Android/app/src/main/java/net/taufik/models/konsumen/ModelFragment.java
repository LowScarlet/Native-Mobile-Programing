package net.taufik.models.konsumen;
...
public class ModelFragment extends Fragment {
    ...
    public void showCreateModal() {
        ...
        // TODO EDIT
        EditText a = Utils.createEditText(context, "nama");
        inputContainer.addView(a);
        EditText b = Utils.createEditText(context, "alamat");
        inputContainer.addView(b);
        EditText c = Utils.createEditText(context, "email");
        inputContainer.addView(c);
        EditText d = Utils.createEditText(context, "nomorHp");
