...
public class ModelFragment extends Fragment {
    ...
    public void showCreateModal() {
        ...
        EditText pemesananId = Utils.createEditText(context, "pemesananId");
        inputContainer.addView(pemesananId);
        ...
        dialogView.findViewById(R.id.createButton).setOnClickListener(v -> {
            Model createdModel = new Model(
                    ...
                    Integer.parseInt(karyawanId.getText().toString()),
                    Integer.parseInt(pemesananId.getText().toString())
            );
    ...
    public void showUpdateModal(Integer id, Model model) {
        ...
        EditText karyawanId = Utils.createEditText(context, "karyawanId");
        karyawanId.setText(String.valueOf(model.karyawanId));
        inputContainer.addView(karyawanId);

        EditText pemesananId = Utils.createEditText(context, "pemesananId");
        pemesananId.setText(String.valueOf(model.pemesananId));
        inputContainer.addView(pemesananId);
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.karyawanId, Integer.parseInt(karyawanId.getText().toString()))) {
                updatedModel.put("karyawanId", Integer.parseInt(karyawanId.getText().toString()));
            }
            if (!Objects.equals(model.pemesananId, Integer.parseInt(pemesananId.getText().toString()))) {
                updatedModel.put("pemesananId", Integer.parseInt(pemesananId.getText().toString()));
            }
