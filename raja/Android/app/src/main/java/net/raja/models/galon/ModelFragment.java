...
public class ModelFragment extends Fragment {
    ...
    public void showCreateModal() {
        ...
        dialogView.findViewById(R.id.createButton).setOnClickListener(v -> {
            Model createdModel = new Model(
                    ...
                    Integer.parseInt(pemasokId.getText().toString())
            );
    ...
    public void showUpdateModal(Integer id, Model model) {
        ...
        EditText stok = Utils.createEditText(context, "stok");
        stok.setText(String.valueOf(model.stok));
        inputContainer.addView(stok);

        EditText pemasokId = Utils.createEditText(context, "pemasokId");
        pemasokId.setText(String.valueOf(model.pemasokId));
        inputContainer.addView(pemasokId);
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.stok, Integer.parseInt(stok.getText().toString()))) {
                updatedModel.put("stok", Integer.parseInt(stok.getText().toString()));
            }
            if (!Objects.equals(model.pemasokId, Integer.parseInt(pemasokId.getText().toString()))) {
                updatedModel.put("pemasokId", Integer.parseInt(pemasokId.getText().toString()));
            }
