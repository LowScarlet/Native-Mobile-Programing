...
import net.raja.Config;
import net.raja.R;
import net.raja.Utils;
...
public class ModelFragment extends Fragment {
    ...
    public void showCreateModal() {
        ...
        EditText galonId = Utils.createEditText(context, "galonId");
        inputContainer.addView(galonId);
        ...
        dialogView.findViewById(R.id.createButton).setOnClickListener(v -> {
            Model createdModel = new Model(
                    ...
                    Integer.parseInt(pelangganId.getText().toString()),
                    Integer.parseInt(galonId.getText().toString())
            );
    ...
    public void showUpdateModal(Integer id, Model model) {
        ...
        EditText pelangganId = Utils.createEditText(context, "pelangganId");
        pelangganId.setText(String.valueOf(model.pelangganId));
        inputContainer.addView(pelangganId);

        EditText galonId = Utils.createEditText(context, "galonId");
        galonId.setText(String.valueOf(model.galonId));
        inputContainer.addView(galonId);
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.pelangganId, Integer.parseInt(pelangganId.getText().toString()))) {
                updatedModel.put("pelangganId", Integer.parseInt(pelangganId.getText().toString()));
            }
            if (!Objects.equals(model.galonId, Integer.parseInt(galonId.getText().toString()))) {
                updatedModel.put("galonId", Integer.parseInt(galonId.getText().toString()));
            }
