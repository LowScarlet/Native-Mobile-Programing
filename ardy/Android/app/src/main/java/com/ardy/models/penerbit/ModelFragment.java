...
public class ModelFragment extends Fragment {
    ...
    public void showCreateModal() {
        ...
        EditText c = Utils.createEditText(context, "lokasi");
        inputContainer.addView(c);
        EditText d = Utils.createEditText(context, "tahunBerdiri");
        inputContainer.addView(d);
        EditText e = Utils.createEditText(context, "emailKontak");
        inputContainer.addView(e);
        EditText f = Utils.createEditText(context, "nomorTelepon");
    ...
    public void showUpdateModal(Integer id, Model model) {
        ...
        EditText lokasi = Utils.createEditText(context, "lokasi");
        lokasi.setText(model.lokasi);
        inputContainer.addView(lokasi);

        EditText tahunBerdiri = Utils.createEditText(context, "tahunBerdiri");
        tahunBerdiri.setText(String.valueOf(model.tahunBerdiri));
        inputContainer.addView(tahunBerdiri);

        EditText emailKontak = Utils.createEditText(context, "emailKontak");
        emailKontak.setText(model.emailKontak);
        inputContainer.addView(emailKontak);

        EditText nomorTelepon = Utils.createEditText(context, "nomorTelepon");
        nomorTelepon.setText(model.nomorTelepon);
        inputContainer.addView(nomorTelepon);
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.lokasi, lokasi.getText().toString())) {
                updatedModel.put("lokasi", lokasi.getText().toString());
            }

            if (!Objects.equals(model.tahunBerdiri, tahunBerdiri.getText().toString())) {
                updatedModel.put("tahunBerdiri", tahunBerdiri.getText().toString());
            }

            if (!Objects.equals(model.emailKontak, emailKontak.getText().toString())) {
                updatedModel.put("emailKontak", emailKontak.getText().toString());
            }

            if (!Objects.equals(model.nomorTelepon, nomorTelepon.getText().toString())) {
                updatedModel.put("nomorTelepon", nomorTelepon.getText().toString());
            }
