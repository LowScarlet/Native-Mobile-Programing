...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String[] arrayOfStrings = {
                ...
                String.format("Tanggal Lahir: %s", data.tanggalLahir),
                String.format("Biografi: %s", data.biografi),
                String.format("Kewarganegaraan: %s", data.kewarganegaraan),
                String.format("Penghargaan: %s", data.penghargaan),
        };
        //
