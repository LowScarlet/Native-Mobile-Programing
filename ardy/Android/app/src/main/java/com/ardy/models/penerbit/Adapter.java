...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String[] arrayOfStrings = {
                ...
                String.format("Lokasi: %s", data.lokasi),
                String.format("Tahun Berdiri: %s", data.tahunBerdiri),
                String.format("Email Kontak: %s", data.emailKontak),
                String.format("Nomor Telepon: %s", data.nomorTelepon),
        };
        //
