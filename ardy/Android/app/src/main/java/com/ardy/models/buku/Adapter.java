...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String[] arrayOfStrings = {
                ...
                String.format("Kode: %s", data.kode),
                String.format("Tahun Terbit: %s", data.tahunTerbit),
                String.format("Halaman: %s", data.halaman),
                String.format("Deskripsi: %s", data.deskripsi),
                String.format("Bahasa: %s", data.bahasa),
                String.format("Penulis Id: %s", data.penulisId),
                String.format("Kategori Id: %s", data.kategoriId),
                String.format("Penerbit Id: %s", data.penerbitId),
        };
        //
