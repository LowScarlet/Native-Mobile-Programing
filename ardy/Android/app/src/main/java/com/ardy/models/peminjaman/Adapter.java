...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String[] arrayOfStrings = {
                ...
                String.format("Tanggal Pinjam: %s", data.tanggalPinjam),
                String.format("Tanggal Kembali: %s", data.tanggalKembali),
                String.format("Tanggal Jatuh Tempo: %s", data.tanggalJatuhTempo),
                String.format("Status: %s", data.status),
                String.format("Denda: %s", data.denda),
                String.format("Buku Id: %s", data.bukuId)
        };
        //
