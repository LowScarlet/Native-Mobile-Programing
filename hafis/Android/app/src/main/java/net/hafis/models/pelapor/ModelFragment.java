package net.hafis.models.pelapor;
...
public class ModelFragment extends Fragment {
    ...
    public void showCreateModal() {
        ...
        EditText telepon = Utils.createEditText(context, "telepon");
        inputContainer.addView(telepon);
    ...
    public void showUpdateModal(Integer id, Model model) {LayoutInflater inflater = LayoutInflater.from(context);
        MaterialAlertDialogBuilder dialogBuilder = new MaterialAlertDialogBuilder(context);
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.telepon, telepon.getText().toString())) {
                updatedModel.put("telepon", telepon.getText().toString());
            }
