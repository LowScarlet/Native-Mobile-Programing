package id.my.lowscarlet.uts_native.models.institution;
...
public class ModelFragment extends Fragment {
    ...
    public void showCreateModal() {
        ...
        inputContainer.addView(Utils.createTextView(context, "accreditation"));
        EditText accreditation = Utils.createEditText(context, null);
        inputContainer.addView(accreditation);
        ...
        dialogView.findViewById(R.id.createButton).setOnClickListener(v -> {
            Model createdModel = new Model(
                    ...
                    accreditation.getText().toString(),
    ...
    public void showUpdateModal(Integer id, Model model) {
        ...
        inputContainer.addView(Utils.createTextView(context, "accreditation"));
        EditText accreditation = Utils.createEditText(context, null);
        accreditation.setText(model.accreditation);
        inputContainer.addView(accreditation);
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.accreditation, accreditation.getText().toString())) {
                updatedModel.put("accreditation", accreditation.getText().toString());
            }
