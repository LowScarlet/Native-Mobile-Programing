...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String[] arrayOfStrings = {
                ...
                String.format("Name: %s", data.name),
                String.format("Description: %s", data.description),
                String.format("Accreditation: %s", data.accreditation),
                String.format("Website: %s", data.website),
        };
        //
