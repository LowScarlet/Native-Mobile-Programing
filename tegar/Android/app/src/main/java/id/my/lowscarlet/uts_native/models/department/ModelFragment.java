package id.my.lowscarlet.uts_native.models.department;
...
public class ModelFragment extends Fragment {
    ...
    public void showCreateModal() {
        ...
        inputContainer.addView(Utils.createTextView(context, "degree"));
        EditText degree = Utils.createEditText(context, null);
        inputContainer.addView(degree);
        //
    ...
    public void showUpdateModal(Integer id, Model model) {
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.degree, degree.getText().toString())) {
                updatedModel.put("degree", degree.getText().toString());
            }
