...
public class Utils {
    ...
    public static TextView createTextView(Context context, String value) {
        ...
        int topMarginPixels = (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_DIP, 8, context.getResources().getDisplayMetrics());
        layoutParams.setMargins(0, topMarginPixels, 0, 0);
    ...
    public static EditText createEditText(Context context, @Nullable String hint) {
    ...
    public static Spinner createSpinner(Context context, List<String> dataList) {
