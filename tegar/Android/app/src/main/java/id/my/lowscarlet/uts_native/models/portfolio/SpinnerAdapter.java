package id.my.lowscarlet.uts_native.models.portfolio;
...
public class SpinnerAdapter  extends ArrayAdapter<Model> {
    ...
    public SpinnerAdapter(@NonNull Context context, List<id.my.lowscarlet.uts_native.models.portfolio.Model> items) {
    ...
    static public void createCallBack(Spinner spinner, Context context, @Nullable Integer defaultId) {
        // TODO EDIT
        Call<List<Model>> call = getHandler().getAllData("portfolio");
        //
