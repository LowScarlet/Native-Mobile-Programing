...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String[] arrayOfStrings = {
                ...
                String.format("Score: %s", data.score),
                String.format("Start Year: %s", data.startYear),
                String.format("End Year: %s", data.endYear),
                String.format("Is Active: %s", data.isActive),
                String.format("Portfolio Id: %s", data.portfolioId),
                String.format("Institution Id: %s", data.institutionId),
                String.format("Department Id: %s", data.departmentId)
        };
        //
