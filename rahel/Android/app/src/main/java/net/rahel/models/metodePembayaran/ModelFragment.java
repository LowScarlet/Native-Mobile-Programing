...
public class ModelFragment extends Fragment {
    ...
    public void showCreateModal() {
        ...
        EditText tipe = Utils.createEditText(context, "tipe");
        inputContainer.addView(tipe);

        EditText keterangan = Utils.createEditText(context, "keterangan");
        inputContainer.addView(keterangan);
    ...
    public void showUpdateModal(Integer id, Model model) {
        ...
        EditText tipe = Utils.createEditText(context, "tipe");
        tipe.setText(model.tipe);
        inputContainer.addView(tipe);

        EditText keterangan = Utils.createEditText(context, "keterangan");
        keterangan.setText(model.keterangan);
        inputContainer.addView(keterangan);

        updateButton.setOnClickListener(v -> {
            Map<String, Object> updatedModel = new HashMap<>();

            if (!Objects.equals(model.tipe, tipe.getText().toString())) {
                updatedModel.put("tipe", tipe.getText().toString());
            }
            if (!Objects.equals(model.keterangan, keterangan.getText().toString())) {
                updatedModel.put("keterangan", keterangan.getText().toString());
            }
