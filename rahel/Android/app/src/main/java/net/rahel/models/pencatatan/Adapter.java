...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String[] arrayOfStrings = {
                ...
                String.format("Nama: %s", data.nama),
                String.format("Nomor Hp: %s", data.nomorHp),
                String.format("Jumlah: %s", data.jumlah),
                String.format("Mulai Sewa: %s", data.mulaiSewa),
                String.format("Petugas Id: %s", data.petugasId),
                String.format("Lokasi Id: %s", data.lokasiId),
