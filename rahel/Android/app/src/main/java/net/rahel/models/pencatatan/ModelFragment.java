...
public class ModelFragment extends Fragment {
    ...
    public void showCreateModal() {
        ...
        EditText nomorHp = Utils.createEditText(context, "nomorHp");
        inputContainer.addView(nomorHp);

        EditText jumlah = Utils.createEditText(context, "jumlah");
        inputContainer.addView(jumlah);

        EditText mulaiSewa = Utils.createEditText(context, "mulaiSewa");
        inputContainer.addView(mulaiSewa);

        EditText petugasId = Utils.createEditText(context, "petugasId");
        inputContainer.addView(petugasId);

        EditText lokasiId = Utils.createEditText(context, "lokasiId");
        inputContainer.addView(lokasiId);
        ...
        dialogView.findViewById(R.id.createButton).setOnClickListener(v -> {
            Model createdModel = new Model(
                    ...
                    mulaiSewa.getText().toString(),
                    Integer.parseInt(petugasId.getText().toString()),
                    Integer.parseInt(lokasiId.getText().toString()),
    ...
    public void showUpdateModal(Integer id, Model model) {
        ...
        EditText nomorHp = Utils.createEditText(context, "nomorHp");
        nomorHp.setText(model.nomorHp);
        inputContainer.addView(nomorHp);

        EditText jumlah = Utils.createEditText(context, "jumlah");
        jumlah.setText(String.valueOf(model.jumlah));
        inputContainer.addView(jumlah);

        EditText mulaiSewa = Utils.createEditText(context, "mulaiSewa");
        mulaiSewa.setText(model.mulaiSewa);
        inputContainer.addView(mulaiSewa);
        ...
        EditText lokasiId = Utils.createEditText(context, "lokasiId");
        lokasiId.setText(String.valueOf(model.lokasiId));
        inputContainer.addView(lokasiId);
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.nomorHp, nomorHp.getText().toString())) {
                updatedModel.put("nomorHp", nomorHp.getText().toString());
            }
            ...
            if (!Objects.equals(model.mulaiSewa, mulaiSewa.getText().toString())) {
                updatedModel.put("mulaiSewa", mulaiSewa.getText().toString());
            }
            ...
            if (!Objects.equals(model.lokasiId, Integer.parseInt(lokasiId.getText().toString()))) {
                updatedModel.put("lokasiId", Integer.parseInt(lokasiId.getText().toString()));
            }
