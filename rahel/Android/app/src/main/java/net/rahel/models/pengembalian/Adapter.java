...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String[] arrayOfStrings = {
                ...
                String.format("Waktu Pengembalian: %s", data.waktuPengembalian),
                String.format("Harga: %s", data.harga),
                String.format("Pencatatan Id: %s", data.pencatatanId),
                String.format("Stok Id: %s", data.stokId),
                String.format("Metode Pembayaran Id: %s", data.metodePembayaranId),
                String.format("Petugas Id: %s", data.petugasId)
        };
        //
